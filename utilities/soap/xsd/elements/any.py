...
from core.utilities.soap import exceptions, ns
from core.utilities.soap.utils import qname_attr
from core.utilities.soap.xsd.const import NotSet, xsi_ns
from core.utilities.soap.xsd.elements.base import Base
from core.utilities.soap.xsd.utils import max_occurs_iter
from core.utilities.soap.xsd.valueobjects import AnyObject
...
class Any(Base):
    ...
    def __init__(
        ...
        # cyclic import
        from core.utilities.soap.xsd import AnyType
    ...
    def render(self, parent, value, render_path=None):
        ...
        if self.accepts_multiple and isinstance(value, list):
            from core.utilities.soap.xsd import AnySimpleType
