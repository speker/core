...
from core.utilities.soap.exceptions import IncompleteMessage
from core.utilities.soap.loader import absolute_location, is_relative_path, load_external
from core.utilities.soap.settings import Settings
from core.utilities.soap.utils import findall_multiple_ns
from core.utilities.soap.wsdl import parse
from core.utilities.soap.xsd import Schema
...
class Definition(object):
    ...
    def parse_binding(self, doc):
        ...
        if not getattr(self.wsdl.transport, "binding_classes", None):
            from core.utilities.soap.wsdl import bindings
