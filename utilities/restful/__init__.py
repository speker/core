...
from core.utilities.rest import request, url_for, current_app
from core.utilities.rest import abort as original_flask_abort
from core.utilities.rest import make_response as original_flask_make_response
from core.utilities.rest.views import MethodView
from core.utilities.rest.signals import got_request_exception
from werkzeug.datastructures import Headers
from werkzeug.exceptions import HTTPException, MethodNotAllowed, NotFound, NotAcceptable, InternalServerError
from werkzeug.wrappers import Response as ResponseBase
from core.utilities.restful.utils import http_status_message, unpack, OrderedDict
from core.utilities.restful.representations.json import output_json
import sys
from core.utilities.rest.helpers import _endpoint_from_view_func
...
class Api(object):
    ...
    def _should_use_fr_error_handler(self):
        ...
        and FR errors (with the correct media type) for FR applications. This
